...
Namespace DentalClinicDataSetTableAdapters
    ...
    Partial Public Class tblLoginTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `tblLogin` WHERE ((`ID` = ?) AND ((? = 1 AND `Username` IS NULL) OR ("& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `tblLogin` SET `Username` = ?, `Password` = ? WHERE ((`ID` = ?) AND ((? = "& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.DentalClinic.My.MySettings.Default.DentalClinicConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Username, [Password] FROM tblLogin"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DentalClinicDataSet.tblLoginDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DentalClinicDataSet.tblLoginDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DentalClinicDataSet.tblLoginDataTable = New DentalClinicDataSet.tblLoginDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DentalClinicDataSet.tblLoginDataTable) As Integer
